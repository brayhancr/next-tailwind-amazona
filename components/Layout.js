  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col justify-between">
            ...
            <div>
              ...
              {status === 'loading' ? (
                ...
                >
                  ...
                  <Menu.Items className="absolute right-0 w-56 origin-top-right bg-white shadow-lg menu-items-rb z-50">
                    <Menu.Item>
                      <DropdownLink
        ...
        <main className="container m-auto mt-4 pt-4">{children}</main>
